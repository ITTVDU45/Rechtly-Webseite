      ...
      <div className="testimonial__container mx-auto max-w-7xl px-6 lg:px-8 sm:px-4 xs:px-3">
        ...
        <div className="mt-16 sm:mt-12 xs:mt-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-3 xs:gap-2 justify-center items-center">
            <Badge variant="secondary" className="px-6 py-3 sm:px-5 sm:py-2.5 xs:px-4 xs:py-2 text-base sm:text-sm xs:text-xs testimonial-badge">📞 02381 / 985000</Badge>
            <Badge variant="secondary" className="px-6 py-3 sm:px-5 sm:py-2.5 xs:px-4 xs:py-2 text-base sm:text-sm xs:text-xs testimonial-badge">✉️ support@rechtly.de</Badge>
          </div>
        </div>
      </div>
    </section>
