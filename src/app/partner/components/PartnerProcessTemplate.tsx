...
import '@/components/sections/ProcessSection/process.css';
...
export default function PartnerProcessTemplate({ title, subtitle, steps, topImage }: Props) {
    ...
    <Section className="section--lg section--white process">
      <div className="section__container process-inner">
        ...
        <div className="process-cta">
          ...
          <div className="microcopy">Unverbindlich. Provision für jeden vermittelten Fall.</div>
        </div>
      </div>
    </Section>
  );
