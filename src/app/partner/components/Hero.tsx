...
export default function Hero() {
  return (
    <Section className="section--lg partner-hero" style={{ background: 'linear-gradient(135deg, #1b3a4b 0%, #2c5364 100%)' }}>
      <div className="partner-hero__inner">
        <div className="partner-hero__copy text-white">
          <h1>Partnerprogramm von Rechtly</h1>
          <p>Werden Sie Partner und erhalten Sie Provision für vermittelte Fälle.</p>
