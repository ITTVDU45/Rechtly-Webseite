...
export default function PortalStatus() {
  return (
    <Section className="section--white my-8 md:my-12">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h2 className="section-title !text-left">Jederzeit alles im Blick</h2>
          <p className="section-subtitle !text-left !ml-0">In deinem persönlichen Portal siehst du jederzeit den aktuellen Stand deines Falls – vom Gutachten bis zur Regulierung.</p>
